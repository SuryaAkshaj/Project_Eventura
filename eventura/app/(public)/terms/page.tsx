    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-8 space-y-8 text-gray-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">2. User Responsibilities</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">3. Organiser Responsibilities</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">4. Payments and Platform Fee</h2>
            ...
            <ul className="list-disc pl-5 space-y-2 text-sm">
              ...
              <li>Refunds are governed by our <Link href="/refunds" className="text-indigo-600 hover:underline">Refund Policy</Link></li>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">5. QR Codes and Check-in</h2>
            <ul className="list-disc pl-5 space-y-2 text-sm">
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-3">6. Certificates</h2>
          ...
          <section>
            ...
            <p>For questions about these terms, contact us at{' '}
              <a href="mailto:legal@eventura.app" className="text-indigo-600 hover:underline">legal@eventura.app</a>
            </p>
          </section>
