    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      <div className="max-w-3xl mx-auto px-6 py-16">
        <div className="mb-10">
          ...
          <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mt-4 mb-2">Refund Policy</h1>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 p-8 space-y-8 text-gray-600 dark:text-gray-400 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3">Attendee Cancellations</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3">Organiser Cancellations</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3">How Refunds Work</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3">Disputes</h2>
            <p>If you believe you are owed a refund that has not been processed, contact us at{' '}
              <a href="mailto:support@eventura.app" className="text-indigo-600 dark:text-indigo-400 hover:underline">support@eventura.app</a>{' '}
